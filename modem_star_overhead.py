...
class MainApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title('Troughput Monitoring Aplication')
        self.frames = {}
...
class StartPage(tk.Frame):
    ...
    def setGui(self):
            ...
            copyright_label = tk.Label(self, font=(
                'Verdana', 10), text=u"\u00A9 Copyright 2020 Nazor Sicda INC.")
...
class Graf(tk.Frame):
    ...
    def start_grafh(self):
        ...
        if self.monitoring.get() == self.index:
            ...
            # AKO SU JOS NA ISTOM WIFI PRIKAZI UPOZORENJE O PROMJENJIVOM OVERHEADU
            if self.index == 0:
                messagebox.showwarning(
                        "UPOZORENJE", """U ZAVISNOSTI OD TIPA MODEMA, OVA KOMBINACIJA INTERFEJSA MOŽE DOVESTI DO ODSTUPANJA U MJERENJU OD: ~ nkbit/s. \nTAKOĐE U SLUČAJU IZRAZITOG ZAGUŠENJA LINKA, MOGUĆI SU ISPADI APLIKACIJE.""")
    ...
    def calculate_overhead(self):
        ...
        if self.OVERHEAD:
            ...
            events = [
                int(event['params']['dataLength']) for event in events if "Network.dataReceived" in event['method']]
    ...
    def calculateBitRate(self):
        ...
        self.bajtdiffer_down = (self.novibajt_down-self.staribajt_down)-self.browserbajt
...
class ModemHG8245H5(Modem):
    ...
    def connect(self):
        ...
        self.browser = webdriver.Chrome(
            CHROMEDRIVER_PATH, options=options, desired_capabilities=caps)
...
class GrafHG8245H5(Graf):
    ...
    def getEthInfo(self):
        ...
        try:
            ...
            self.browserbajt = self.calculate_overhead()
...
class GrafHG8245H(Graf):
    ...
    def getWlanInfo(self):
        ...
        try:
            ...
            #SRACUNAJ OVERHEDA
            self.browserbajt = self.calculate_overhead()
            print("self.browserbajt: ", self.browserbajt)
...
class ModemZTE_H267N(Modem):
    ...
    def connect(self):
        ...
        events = [json.loads(entry['message'])['message']
                  for entry in browser_log]
        events = [
            int(event['params']['encodedDataLength']) for event in events if "Network.dataReceived" in event['method']]
